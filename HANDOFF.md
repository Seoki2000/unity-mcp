...
최종 갱신: 2026-08-27 (P3-a + SequencePoints + search folder + 중첩 타입 + **P3-b**. 로드맵 소진)
...
| 프로브 | `probe-error-impact` **10/10** · `probe-nested-types` **8/8** · `probe-method-lines` **7/7** · `probe-verify-loop` **7/7** · `probe-impact-analysis` **10/10** · `probe-project-map` 통과 |
...
- `Tools/probe-error-impact.js` — P3-b 조인 프로브 10개 (신규)
